...
execute if score kick auth.settings matches 1 if score kick_time auth.settings matches 1 if score @s auth.kick_time matches 600.. run return run function auth:player/kick
