...
execute if score kick auth.settings matches 1 if score kick_delay auth.settings matches 1 run scoreboard players add @s auth.kick_delay 1
execute if score kick auth.settings matches 1 if score kick_delay auth.settings matches 1 if score @s auth.kick_delay matches 1200.. run return run function auth:player/kick
