...
execute if score kick_time auth.settings matches 1 run tellraw @s [{"text":"- Kick Time (30 seconds): ","color":"gray"},{"text":"YES","color":"green"},{"text": " - ","color":"gray"},{"text":"NO","color":"gray","clickEvent":{"action":"run_command","value":"/function auth:settings/kick_time/no"}}]
execute if score kick_time auth.settings matches 0 run tellraw @s [{"text":"- Kick Time (30 seconds): ","color":"gray"},{"text":"YES","color":"gray","clickEvent":{"action":"run_command","value":"/function auth:settings/kick_time/yes"}},{"text": " - ","color":"gray"},{"text":"NO","color":"green"}]
